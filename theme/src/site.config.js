...
export default {
  screens: {
    sm: parseInt(config.screens.sm.slice(0, -2)),
    md: parseInt(config.screens.md.slice(0, -2)),
    lg: parseInt(config.screens.lg.slice(0, -2)),
    xl: parseInt(config.screens.xl.slice(0, -2)),
    fw: parseInt(config.screens.fw.slice(0, -2)),
  },
  gutter: {
